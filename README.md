...
[Proton](https://github.com/ValveSoftware/Proton/) ⭐ 32,654 | 🐛 5,175 | 🌐 C++ | 📅 2026-08-26 is a tool for use with the Steam client which allows games which are exclusive to Windows to run on the Linux operating system. It uses Wine to facilitate this.
...
[Kata Operator](https://github.com/openshift/kata-operator) ⭐ 50 | 🐛 48 | 🌐 Shell | 📅 2026-08-26 is an operator to perform lifecycle management (install/upgrade/uninstall) of [Kata Runtime](https://katacontainers.io/) on Openshift as well as Kubernetes cluster.
...
[K3s](https://github.com/rancher/k3s) ⭐ 33,823 | 🐛 73 | 🌐 Go | 📅 2026-08-25 is a highly available, certified Kubernetes distribution designed for production workloads in unattended, resource-constrained, remote locations or inside IoT appliances.
...
[The JPL Open Source Rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,609 | 🐛 16 | 🌐 Prolog | 📅 2026-08-13 is an open source, build it yourself, scaled down version of the 6 wheel rover design that JPL uses to explore the surface of Mars. The Open Source Rover is designed almost entirely out of consumer off the shelf (COTS) parts. This project is intended to be a teaching and learning experience for those who want to get involved in mechanical engineering, software, electronics, or robotics.
...
[EarlyOOM](https://github.com/rfjakob/earlyoom) ⭐ 4,240 | 🐛 34 | 🌐 C | 📅 2026-08-20 is a daemon for Linux that enables users to more quickly recover and regain control over their system in low-memory situations with heavy swap usage.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,309 | 🐛 619 | 🌐 Go | 📅 2026-08-26 is an unsupervised, coverage-guided kernel fuzzer.
...
[Podman(the POD MANager)](https://github.com/containers/podman) ⭐ 32,698 | 🐛 1,136 | 🌐 Go | 📅 2026-08-26 is a tool for managing [OCI](https://opencontainers.org/) containers and pods.
...
[Style Guide for Flutter](https://github.com/flutter/flutter/wiki/Style-guide-for-Flutter-repo) ⭐ 178,661 | 🐛 13,165 | 🌐 Dart | 📅 2026-08-26
...
[Go-flutter](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-08-23 is a package that brings Flutter to the desktop. project implements the [Flutter's Embedding API](https://github.com/flutter/flutter/wiki/Custom-Flutter-Engine-Embedders) ⭐ 178,661 | 🐛 13,165 | 🌐 Dart | 📅 2026-08-26 using a single code base that runs on Windows, macOS, and Linux. For rendering, [GLFW](https://github.com/go-gl/glfw) ⭐ 1,690 | 🐛 22 | 🌐 C | 📅 2026-08-23 fits the job because it provides the right abstractions over the OpenGL's Buffer/Mouse/Keyboard for each platform.
